...
import { getEmbeddedAppUrl, openTopLevelUrl } from "../utils/embeddedNavigation";
  ...
  const faqs = [
    {
      ...
      answer:
        "Our subscription plans are billed monthly through your Shopify account. You can upgrade, downgrade, or cancel your subscription at any time. All charges appear directly on your Shopify invoice.",
    },
    {
      question: "What happens if I exceed my plan limits?",
      answer:
        "You'll receive notifications when you're approaching your limit. You can upgrade your plan at any time to increase your limits without losing any data or configurations.",
    },
    {
      question: "How do I cancel my subscription?",
      answer:
        "You can cancel your subscription at any time from the subscription management page. Your plan will remain active until the end of your billing period, and you can continue using all features during that time.",
    },
    {
      question: "Can I switch between plans?",
      answer:
        "Yes! You can upgrade or downgrade at any time. Upgrades take effect immediately with prorated billing, while downgrades take effect at the start of your next billing cycle.",
    },
    {
      question: "Is my data secure?",
      answer:
        "Absolutely. All data is encrypted in transit and at rest. We follow industry best practices and comply with Shopify's security requirements to keep your information safe.",
    },
  ];
    ...
    async (plan) => {
      try {
        ...
        const response = await fetchWithAuth("/api/subscription/create-subscription", {
          ...
          body: JSON.stringify({
            planKey: plan.key,
            returnUrl: getEmbeddedAppUrl("/pricing"),
          }),
        });
