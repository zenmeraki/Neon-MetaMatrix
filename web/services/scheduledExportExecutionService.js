...
import { assertShopIsActive } from "../utils/sessionHandler.js";
import {
...
export async function executeScheduledExportRun(runId, shopFromJob = null) {
  ...
  try {
    await assertShopIsActive(scheduledExport.shop);
  } catch (_error) {
    await markRunSkipped(run, scheduledExport, "Shop is no longer active");
