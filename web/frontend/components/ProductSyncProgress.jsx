...
export default function ProductSyncPage({ verifyStoreAccess }) {
  ...
  const fetchSyncProgress = useCallback(async () => {
    try {
      const response = await fetchWithAuth("/api/sync/product-track");
      if (!response) {
        return;
      }
      ...
      // Keep the progress surface stable if realtime refresh fails.
    }
  }, [fetchWithAuth]);
      ...
      <BlockStack gap="500">
        ...
        <Card>
          <BlockStack gap="400">
            ...
            <BlockStack gap="300">
              <ProgressBar progress={syncStatus.progress} size="small" tone="primary" />

              <InlineStack align="space-between">
                <Text variant="bodySm" as="p" tone="subdued">
                  {syncStatus.processedProducts} of {syncStatus.totalProducts} products
                  {" "}processed
                </Text>
        ...
        {syncStatus.status === "completed" && (
          <Card>
            <BlockStack gap="400">
              ...
              <Text variant="bodyMd" as="p" tone="subdued">
                Your products are now available in Metamatrix. You can start making
                bulk edits, update pricing, manage inventory, and streamline your
        ...
        <Card>
          <BlockStack gap="300">
            ...
            <Text variant="bodyMd" as="p" tone="subdued">
              ...
              process syncs all your product data including titles, descriptions,
              variants, prices, and inventory levels so you can edit them in bulk
              using our platform.
            </Text>
