...
if (!globalThis.__scheduledExportSchedulerStarted) {
  ...
  globalThis.__scheduledExportSchedulerTimeout = setTimeout(runSchedulerTick, 5_000);
  globalThis.__scheduledExportSchedulerInterval = setInterval(
    runSchedulerTick,
...
export default {
  pollIntervalMs: SCHEDULE_INTERVAL_MS,
  close() {
    clearTimeout(globalThis.__scheduledExportSchedulerTimeout);
    clearInterval(globalThis.__scheduledExportSchedulerInterval);
  },
};
