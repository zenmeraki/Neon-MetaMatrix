      ...
      <Autocomplete
        ...
        textField={
          <Autocomplete.TextField
            labelHidden
            placeholder={t("productsFilterSearchPlaceholder", {
  ...
  const filters = useMemo(
    () =>
      allFilters.map((filter) => {
        const filterLabel = t(filter.label, { defaultValue: filter.label });
    ...
    [allFilters, autocompleteLoading, autocompleteOptions, draftFilters, onFilterChange, t],
  );
  ...
  return (
    <BlockStack gap="100">
      <Text as="h3" variant="headingSm">
        {t("productsFiltersTitle", { defaultValue: "Filters" })}
      </Text>
      <Text as="p" variant="bodySm" tone="subdued">
        {t("productsFiltersDescription", {
          defaultValue:
