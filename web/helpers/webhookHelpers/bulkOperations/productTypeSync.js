...
import { assertSafeExternalUrl } from "../../../utils/externalUrlSecurity.js";
...
export async function handleSyncOperation({ bulkOperationId, shop = null }) {
  ...
  try {
    ...
    const safeUrl = await assertSafeExternalUrl(new URL(bulkOperation.url).toString());
    const urlResponse = await axios.get(safeUrl, {
