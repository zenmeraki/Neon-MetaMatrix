...
export default function DashboardPage() {
  ...
  const goSnippets = useCallback(
    () => navigate("/product-code-snippets"),
    [navigate]
  );
  const goSuggestions = useCallback(
  ...
  const handleSyncNow = useCallback(async () => {
    ...
    try {
      ...
      if (import.meta.env.DEV) {
        console.warn("Failed to start product sync", error);
      }
    } finally {
  ...
  const handleDismissFreeAccess = useCallback(() => {
    ...
    () => [
      ...
      },
      {
        ...
        requiresSyncedCatalog:
          actionGuards.exportProducts.requiresSyncedCatalog,
        onAction: () =>
          runNavigationAction(
            "export-products",
            goExport,
      ...
      },
      {
        ...
        requiresSyncedCatalog:
          actionGuards.importProducts.requiresSyncedCatalog,
        onAction: () =>
          runNavigationAction(
            "import-spreadsheet",
            goImport,
  ...
  return (
    ...
    >
      <Layout>
        {hasDashboardBanners ? (
          <Layout.Section>
            <DashboardBanners
              ...
              onDismissFreeAccess={handleDismissFreeAccess}
        ...
        {isLargeStore ? <Layout.Section>{catalogCard}</Layout.Section> : null}
