...
export const APP_INSTALLATION_QUEUE_NAME =
  process.env.APP_INSTALLATION_QUEUE || "app-installation";
...
export const appInstallationQueue = new Queue(APP_INSTALLATION_QUEUE_NAME, {
  connection,
  defaultJobOptions,
});
